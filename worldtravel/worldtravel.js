const places = [
    {
        ...
        mapImage: 'images/leaning-tower-pisa-map.png',
    ...
    },
    {
        ...
        mapImage: 'images/mt-everest-map.png',
    ...
    },
    {
        ...
        mapImage: 'images/mt-fuji-map.png',
        tags: ['Mountain', 'Asia', 'Nature', ]
    },
    {
        id: 'paris',
    ...
    },
    {
        ...
        mapImage: 'images/barrier-reef-map.png',
    ...
    },
    {
        ...
        mapImage: 'images/great-wall-china-map.png',
    ...
    },
    {
        ...
        mapImage: 'images/machu-picchu-map.png',
    ...
    },
    {
        ...
        mapImage: 'images/lourve-map.png',
    ...
    },
    {
        ...
        mapImage: 'images/giza-pyramid-map.png',
    ...
    },
    {
        ...
        mapImage: 'images/grand-canyon-map.png',
...
function placeTemplate(place) {
    ...
    <div class="place-details">
        ...
        <button class="modal-button" id="${place.id}">See More</button>
...
let modalDetails = modal.querySelector("#modal-details");
...
// modalButton.forEach(function(modalButton) {
    ...
    placeContainer.addEventListener('click', openModal);
    function openModal(e) {
        if (e.target.classList.contains('modal-button')) {
            let placeId = e.target.id;
            modal.style.display = 'flex';
            function populateModal(place){
                return `<div id="modal-top">
                            <img id="map-img" src="${place.mapImage}" alt="${place.name}">
                        <div id="head-tags">
                            <h2 id="modal-name">${place.name}</h2>
                            <div id="modal-tags">${tagTemplate(place.tags)}</div>
                        </div>
                    </div>
                        <p id="description">${place.description}<br><a id="wiki-link" href="${place.link}" target="_blank">Read more on Wikipedia</a></p>
            ...
            places.forEach(place => {
                if (placeId === place.id) {
                    let details = populateModal(place);
    ...
    // get e.target.id on click
    // search places by ID using foreach
    // populate modal using place in places
